...
| `apps/inventory-web` | Static Astro frontend — GM item catalog/instance management, kanban-style container board, LorenzoScript descriptions, tag, information and slug editing, players' notes; end-to-end tests against the real API (`mise run //apps/inventory-web:test-e2e`, ADR 0114) |
