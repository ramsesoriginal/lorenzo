...
erDiagram
    ...
    ENTITY_SLUG {
        uuid entity_id PK,FK "one slug per entity"
        uuid tenant_id FK
        string slug "unique per tenant"
    }
    BEING {
