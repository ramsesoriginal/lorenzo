...
2. **Authorized Redirect URIs**: add `https://lorenzo-account-hub.pages.dev/auth/redirect` (the production Pages URL once step 3 above exists) and, for local dev, `http://127.0.0.1:4322/auth/redirect`.
