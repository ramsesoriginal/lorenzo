...
Status: proposed; sub-slices 1 and 3 (and description edits from sub-slice 4) accepted by [ADR 0101](../adr/0101-editable-information-and-description-payloads.md); sub-slice 2 accepted by [ADR 0107](../adr/0107-entity-slugs-and-batch-resolve.md), as RFC 0027 stage 5; sub-slices 5 and 6 accepted by [ADR 0109](../adr/0109-player-knowers-knower-listing-and-information-list.md)
