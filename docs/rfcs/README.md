...
- [0004 - User, membership, player, character, and GM read REST API](0004-user-membership-player-character-gm-read-api.md) — proposed, builds on RFC 0003; `/me`'s players carry their characters, and the tenant roster is a discriminated union of owner/orga, players, and GMs, not just owner/orga
