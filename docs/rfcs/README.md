...
- [0001 - Core domain data model (entity/component architecture)](0001-core-domain-data-model.md) — proposed, pending the knowledge/redaction, tenancy-split, and multi-game-system questions
