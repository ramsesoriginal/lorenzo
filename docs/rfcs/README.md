...
- [0004 - User, membership, player, character, and GM read REST API](0004-user-membership-player-character-gm-read-api.md) — proposed, builds on RFC 0003; `/me`'s players carry their characters, and the tenant roster now includes players too (a discriminated union), not just owner/orga
