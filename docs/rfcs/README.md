...
- [0005 - Item and item-instance CRUD API](0005-item-and-item-instance-crud-api.md) — proposed, the first write surface in this codebase; defines cross-cutting write-API conventions; now depends on RFC 0010 for `entity.created_by`/`updated_by`
...
- [0010 - Attribution — created_by/updated_by](0010-created-by-updated-by-attribution.md) — proposed, adds the pair to entity/campaign/membership/player/character only (not every table) now that RFC 0005/0006/0007 introduce the first write paths
