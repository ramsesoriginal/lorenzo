...
- [0008 - Effective stat resolution over the prototype graph](0008-effective-stat-resolution.md) — proposed, deliberately short; schedules building RFC 0001's already-decided resolution rule, and now also names stat-writing (entity_stat/stat_definition/stat_group CRUD) as an equally unfinished part, both deferred to the same second pass
