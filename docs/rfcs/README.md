...
- [0007 - User, player, and character CRUD API](0007-user-player-character-crud-api.md) — proposed, builds on RFC 0004/0005; resolves ADR 0010's invitation-flow question with a known limitation; `DELETE /characters/{id}` demotes to a plain being rather than destroying it
