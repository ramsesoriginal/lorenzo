...
# See ADR 0053 - a platform-wide capability orthogonal to tenant
...
async def list_all_users(
    ...
    substring match against nickname/email, unlike ADR 0051's deliberately
...
async def suspend_user(
    ...
    idempotent-PUT precedent. See ADR 0053: the target's *next* request,
...
async def create_platform_notification_route(
    ...
    """scope="platform" - see ADR 0054. `recipient_user_id` is required
