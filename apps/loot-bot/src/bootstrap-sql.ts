 ...
 * extended for the two things that migration didn't need (see ADR 0050,
...
/** Fixed by ADR 0050 - not environment-derived like the role/password are. */
 ...
 * exist is to never need anything outside its own schema (ADR 0050).
 */
