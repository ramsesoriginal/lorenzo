...
| Discord bot(s) | Talks to the API | [`apps/loot-bot`](apps/loot-bot) — in progress: Discord account linking, "my inventory", and loot-splitting (see [ADR 0042](docs/adr/0042-loot-bot-stack-linking-and-isolation.md)/[0043](docs/adr/0043-loot-bot-give-command.md)) |
